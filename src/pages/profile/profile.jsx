...
export default function ProfilePage (){
    ...
    const Element = () => {
        ...
        <Collapse className ="Collapse_container lg:text-xl md:text-base sm:text-sm lg:w-[60%] md:w-[70%] sm:w-[90%] font-Pixel" style={{'backgroundColor' : '#ffffff'}} defaultActiveKey={['1']}>
    ...
    items={[
      {
        title:  <h2><div className='flex space-x-[50px]'><img className="lg:h-[80px] lg:w-[80px] sm:h-[35px] sm:w-[35px] "src={Terralogic}/><h1><a className='lg:text-base sm:text-sm hover:font-bold hover:text-black' target="_blank" href='https://terralogic.com/'>Terralogic Inc,</a></h1></div></h2>,
        description :     
        <>
