...
const HomePage = () =>{
    ...
    return (
        <>
        <div className='body_home h-screen w-screen flex flew-col justify-between p-4'>
        <div className="left-component share_butt p-5">
            <Button type="dashed" className="text-black bg-white px-2">
            ...
            <div className="center-component w-[40%] bg-white justify-center space-x-5 h-full rounded-2xl">
                <HomePageComponent/>
            </div>
