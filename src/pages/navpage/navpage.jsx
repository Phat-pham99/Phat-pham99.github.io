...
const NavBar = () => (
<div className="NavPage-level sticky top-0 z-30 backdrop-filter backdrop-blur-sm hover:backdrop-blur bg-opacity-20 border border-[#c7c7c7] bg-white flex flex-row justify-center p-4 w-full ">
