...
const NavBar = () => (
<div className="NavPage-level sticky top-0 backdrop-filter backdrop-blur-sm hover:backdrop-blur bg-opacity-30 border-b border-[#f2f2f2] flex flex-row justify-center p-4 w-full bg-[#33ffad]">
