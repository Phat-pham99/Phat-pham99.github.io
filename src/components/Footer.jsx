...
export default function Footer() {
  return (
    <footer className="border-b border-zinc-800 bg-btop-bg">
      <div className="mx-auto flex max-w-content items-center justify-between border-x border-zinc-800 px-0 font-mono text-xs">
        {/* Help bar - left */}
        <div className="flex items-center">
          <div className="border-r border-zinc-800 bg-zinc-900/40 px-3 py-2 text-zinc-500">
        ...
        <div className="flex items-center">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="border-l border-zinc-800 px-3 py-2 text-zinc-500 transition-colors hover:text-brand"
          >
