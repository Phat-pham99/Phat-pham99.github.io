...
const Footer = () =>{
    ...
    return (
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">Icons provided by <a className="hover:underline"target="_blank"href="https://icons8.com/">icons8</a></span>
        </div>
